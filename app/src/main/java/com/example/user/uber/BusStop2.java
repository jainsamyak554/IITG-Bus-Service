 ...
 *                     : Samyak Jain 14/3/17
 *
 * Synopsis of the module: This module shows the distance to the current and estimated arrival time of the bus to the bus stop2.
 *
 */
...
public class BusStop2 extends FragmentActivity implements OnMapReadyCallback,
    ...
    private static final int[] COLORS = new int[]{R.color.common_google_signin_btn_text_light_focused, R.color.colorAccent, R.color.colorPrimary,R.color.common_google_signin_btn_text_dark_default};
    ...
    private void getDistancefromStop(){
        ...
        destinationMarkerOptions.title("Nearest Bus Stop");
        driverMarker=mMap.addMarker(destinationMarkerOptions);
    ...
    private void getRouteToMarker(LatLng latLng){
        Routing routing = new Routing.Builder()
                ...
                .waypoints(latLng,new LatLng(26.188297,91.6927414))
                .build();
        routing.execute();
    }
