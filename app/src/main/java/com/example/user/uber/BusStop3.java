 ...
 *                     : Samyak Jain 14/3/17
 *
 * Synopsis of the module: This module shows the distance to the current and estimated arrival time of the bus to the bus stop3
 *
 */
...
public class BusStop3 extends FragmentActivity implements OnMapReadyCallback,
